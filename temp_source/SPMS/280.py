...
#     plt.axis([0,cost_history.shape[0],np.min(cost_history),np.max(cost_history)])
#     plt.show()
...
#         x_train_data[:,3:7] =  robust_scaler1.transform(np.ones(x_train_data.shape[1])*0)[0]
